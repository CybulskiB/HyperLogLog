...
def createplot(b):
    ...
    i = 0
    with open('Results/SHA1/Res' + b +'.csv',"r") as file:
        for line in file:
            i += 1
            x,  y, z = line.split(";")
            if z == "small\n":
    ...
    plt.title("SHA1, b = "+ b + " Small correction- yellow, Intermediate correction- blue, Large correction -red")
    plt.xlabel("n")
    plt.ylabel("res/n")
    ...
    plt.savefig('Histograms/SHA1/Plot' + b + '.png')
